...
This repository contains Jupyter notebooks that visually analyze US Economic data as provided by [St. Louis Fed](https://fred.stlouisfed.org) and the [OECD](https://stats.oecd.org). The analysis is carried out using [Pandas](https://pandas.pydata.org), [Pandas datareader](https://pydata.github.io/pandas-datareader/), and [Matplotlib](https://matplotlib.org/stable/index.html).
...
[here for the analysis of the quantitative easing and tapering by the Fed](https://github.com/ilchen/US_Economic_Data_Analysis/blob/main/Quantitative_Easing_and_Tapering.ipynb),
[here for the analysis of trends in US Industrial production and its current state](https://github.com/ilchen/US_Economic_Data_Analysis/blob/main/Industrial_Production.ipynb),
[here for the analysis of trends in US GDP composition and its current state](https://github.com/ilchen/US_Economic_Data_Analysis/blob/main/GDP_Composition.ipynb), and
[here for the analysis of trends in US labor productivity and its comparison to that in the EU](https://github.com/ilchen/US_Economic_Data_Analysis/blob/main/Labor_Productivity.ipynb).
